...
export default function MenteeDashboard() {
  ...
  // ✅ NEW: mentors that are logged in as mentor (from Mentor collection)
  const [mentors, setMentors] = useState([]);

  // helper to fetch mentors who are currently logged in (isOnline=true)
  ...
  useEffect(() => {
    ...
    // ✅ Fetch currently online mentors
    fetchOnlineMentors();
    ...
    // ✅ Update mentors list when mentors log in/out (server should emit these)
...
//     // Fetch leave history
//     axios
//       .get("http://localhost:5000/api/leave/mentor/${mentorId}")
//       .then((res) => {
//         const myLeaves = res.data.filter((l) => l.menteeId === studentId);
//         setLeaveHistory(myLeaves);
//       })
...
//     const updateData = {
//       ...formData, mentorId: student.mentorId,
//       meetingsAttended: Number(formData.meetingsAttended),
//       cgpa: Number(formData.cgpa),
//       classAttendance: Number(formData.classAttendance),
//       backlogs: Number(formData.backlogs),
...
//     if (!leaveData.fromDate || !leaveData.toDate || !leaveData.reason|| !selectedMentor) {
//       return alert("Please fill all leave fields");
//     }

//     axios
//       .post("http://localhost:5000/api/leave", {
//         menteeId: studentId,  mentorId: selectedMentor,
//         menteeName: student?.rollNumber,
//         ...leaveData,
//       })
//       .then((res) => {
